...
//                }
                if (isExactly) {
                    mTotalLength += lp.leftMargin + lp.rightMargin + TOTAL_CIRCLE_WIDTH + separatorWidth;
                } else {
                    final int totalLength = mTotalLength;
                    mTotalLength = Math.max(totalLength, totalLength +
                            lp.leftMargin + lp.rightMargin + TOTAL_CIRCLE_WIDTH + separatorWidth);
                }
...
//                }
    ...
    private void setChildFrame(View child, int left, int right, int top, int bottom, int width, int height) {
        ...
        rects.add(new Rect(left - TOTAL_CIRCLE_WIDTH, top, right, bottom));
    }
