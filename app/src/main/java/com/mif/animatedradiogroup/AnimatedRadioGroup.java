...
//        setupAnimation(new DrawVAnimation());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (getOrientation() == VERTICAL) {
            measureVerticalV2(widthMeasureSpec, heightMeasureSpec);
        } else {
            measureHorizontalV2(widthMeasureSpec, heightMeasureSpec);
        }
    }
    /**
     ...
     */
    void measureHorizontalV2(int widthMeasureSpec, int heightMeasureSpec) {
        mTotalLength = 0;
        int maxHeight = 0;
        int childState = 0;
        ...
        if (mTotalLength > 0 && this.hasDividerBeforeChildAt(count)) {
            mTotalLength += getDividerWidth();
        }
    ...
    protected boolean hasDividerBeforeChildAt(int childIndex) {
        ...
        boolean allViewsAreGone = allViewsAreGoneBefore(childIndex);
        if (allViewsAreGone) {
     ...
     * @see #onMeasure(int, int)
     */
    void measureVerticalV2(int widthMeasureSpec, int heightMeasureSpec) {
        mTotalLength = 0;
        int maxWidth = 0;
        int childState = 0;
        int alternativeMaxWidth = 0;
